...
genai.configure(api_key=os.getenv("AIzaSyD-NiBEpY_wolM8CAq-6Ex4uj46-VzfPSI"))
...
with st.sidebar:
    ...
    - [Github](https://github.com/rajeshpolipalli?tab=repositories) Repository
                
    """)
    
    add_vertical_space(5)
    st.write("Made with ❤ by Rajesh.")
